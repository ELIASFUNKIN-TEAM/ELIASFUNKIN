...
function onEvent(n,v1,v2)
      if n == 'Colored_Apple' then
		if v1 == '' or v1 == '0' then
			...
			callOnHScript('ColorApple', {'boyfriend', rgbbf[1], rgbbf[2], rgbbf[3], v1})
			callOnHScript('ColorApple', {'dad', rgbdad[1], rgbdad[2], rgbdad[3], v1})
			callOnHScript('ColorApple', {'gf', rgbgf[1], rgbgf[2], rgbgf[3], v1})
        			--runHaxeCode([[
					--	FlxTween.tween(game.boyfriend, {x : 100}, 1, {ease: FlxEase.linear});
        			--	FlxTween.tween(game.boyfriend.colorTransform, { redOffset: ]]..rgbbf[1]..[[, greenOffset: ]]..rgbbf[2]..[[, blueOffset: ]]..rgbbf[3]..[[, redMultiplier: 1, greenMultiplier: 1, blueMultiplier: 1 }, ]]..v1..[[);
    				--	FlxTween.tween(game.dad.colorTransform, { redOffset: ]]..rgbdad[1]..[[, greenOffset: ]]..rgbdad[2]..[[, blueOffset: ]]..rgbdad[3]..[[, redMultiplier: 1, greenMultiplier: 1, blueMultiplier: 1 }, ]]..v1..[[);
    				--]])
