...
class Achievements {
	public static function init()
	{
		...
		// 캐릭터 클리어와 풀콤 관련
		createAchievement('erpin_clear',			{name: "BBAAAAANG!!!", description: "Beat Erpin on Hard."}, 													"ELLIASFUNKIN");
		createAchievement('erpin_nomiss',			{name: "He is not bread, idiot!", description: "Beat Erpin on Hard with no Misses.", hidden: true}, 					"ELLIASFUNKIN");
		createAchievement('kyarot_clear',			{name: "Kyarot Carrot", description: "Beat Kyarot on Hard."}, 														"ELLIASFUNKIN");
		createAchievement('kyarot_nomiss',			{name: "Wanna have some sugarcane?", description: "Beat Kyarot on Hard with no Misses.", hidden: true}, 			"ELLIASFUNKIN");
		createAchievement('furry_clear',			{name: "New friends!", description: "Beat Furrys on Hard."}, 														"ELLIASFUNKIN");
		createAchievement('furry_nomiss',			{name: "Furry's furious", description: "Beat Furrys on Hard with no Misses.", hidden: true}, 						"ELLIASFUNKIN");
