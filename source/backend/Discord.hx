...
class DiscordClient
{
	...
	private inline static final _defaultID:String = "1375732932907499600";
	...
	public static function changePresence(details:String = 'In the Title', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'ef_logo')
	{
		...
		presence.largeImageText = "ELLIASFUNKIN Version: " + states.MainMenuState.modVersion;
