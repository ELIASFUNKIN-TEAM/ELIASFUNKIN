...
@:structInit class SaveVariables {
	...
	public var pauseMusic:String = 'This Is Awkward (Safahire Mix)';
...
class ClientPrefs {
	...
	public static function resetProgressOnly() {
		var progressSaves = ['scoreSaveData', 'freeplaySongUnlocks', 'achievements'];

		for (saveName in progressSaves) {
			var save:FlxSave = new FlxSave();
