...
class FunkinLua {
	...
	public function new(scriptName:String) {
		...
		// death?
		Lua_helper.add_callback(lua, "setCanDeath", function(value:Bool = true) game.canDeath = value);
		Lua_helper.add_callback(lua, "getCanDeath", function() return game.canDeath);
		...
		// dialogue
		Lua_helper.add_callback(lua, "getTextSizeSetting", function(value:String = 'Middle') game.textSize = value);
		Lua_helper.add_callback(lua, "getTextSizeSetting", function() return game.textSize);
		Lua_helper.add_callback(lua, "setTextSpeedSetting", function(value:String = 'Fast') game.textSpeed = value);
		Lua_helper.add_callback(lua, "getTextSpeedSetting", function() return game.textSpeed);
		Lua_helper.add_callback(lua, "setInteraction", function(value:Bool = true) game.interaction = value);
		Lua_helper.add_callback(lua, "getInteraction", function() return game.interaction);
